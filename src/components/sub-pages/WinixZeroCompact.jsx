...
import winixZeroCompact from '../../assets/images/WinixCompact.png';

const WinixZeroCompact = () => {
	const purifierDetails = techSpecs.purifiers[3];
	return (
		<div className='technical-spec-container'>
			<h1>Technical specs for the Winix Zero Compact</h1>
			<div className='specs-and-img-container'>
				<div className='specs-container'>
					...
					<div className='techspecs-small-container'>
						<img src={blueTick} alt='tick svg' />
						<h6 className='tech-text'>Auto mode: {purifierDetails.autoMode}</h6>
					</div>
					<div className='techspecs-small-container'>
						<img src={blueTick} alt='tick svg' />
						<h6 className='tech-text'>
				...
				<div className='tech-img-container'>
					<img src={winixZeroCompact} alt='winix zero compact' />
				</div>
			</div>
		</div>
	);
...
export default WinixZeroCompact;
