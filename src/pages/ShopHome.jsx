...
const ShopHome = () => {
	...
	return (
		<>
			<div className='main-and-section'>
			...
			<div className='ptext2'>
				...
				<h5>
					...
					able to see a selection of our best air circulation systems and all of
					the technical specs associated with them.
				</h5>
				<Link to='/fans'>
					<button className='shop-btn'>Shop Now</button>
				</Link>
			...
			<div className='ptext4'>
				...
				<h5>
					Our selection of heaters will be coming soon! Check back here shortly
					for further details.
				</h5>
				<Link to='/'>
					<button className='shop-btn'>Shop Now</button>
